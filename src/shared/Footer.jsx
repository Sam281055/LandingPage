            ...
            <div className='my-12 flex flex-col md:flex-row gap-10'>
                <div className='md:w-1/2 space-y-8'>
                    <a href="/" className="text-2xl font-semibold flex items-center space-x-3 text-primary">
                        <img src={react} className="w-10 inline-block items-center" /> <span className='text-white'>XYZ</span>
                    </a>
                    <p className='md:w-1/2 '>A simple paragraph is comprised of three major components.
                        The first sentence, which if often a declarative sentence.</p>
                    <div>
                ...
                <div className='md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start'>
                    ...
                    <div className='space-y-4 mt-5'>
                        ...
                        <ul className='space-y-3'>
                            <a href="/" className='block hover:text-gray-300'>(021) 132-231</a>
                            <a href="/" className='block hover:text-gray-300'>321 XYZ XYZ</a>
                            <a href="/" className='block hover:text-gray-300'>Asuncion-Paraguay</a>
                            <a href="/" className='block hover:text-gray-300'>1506</a>
                        </ul>
                    </div>
                </div>
            </div>
